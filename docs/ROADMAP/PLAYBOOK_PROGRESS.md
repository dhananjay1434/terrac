...
**Next actionable task:** P1-C5 (END-BURN error humanize + gating widget test — gating already exists at pyrolysis_screen:289). Then C6 (passphrase read-back-verified migration), C7 (two-phase insert invariant).
