...
async def test_single_sample_temp_rejected(client: AsyncClient, registered_device):
    ...
    headers = {
        ...
        "X-Signature": sign_request(
            dev_id, b64_key, "POST", "/api/v1/batches", "op-single", payload
        ),
    }
...
async def test_full_log_required_for_compliant_penalty(
    ...
    await client.post(
        ...
        headers={
            ...
            "X-Signature": sign_request(
                dev_id, b64_key, "POST", "/api/v1/telemetry", "op-tel-full", tel
            ),
        },
    )
    yld = {
    ...
    await client.post(
        ...
        headers={
            ...
            "X-Signature": sign_request(
                dev_id, b64_key, "POST", "/api/v1/yield", "op-yld-full", yld
            ),
        },
    )
    ...
    headers = {
        ...
        "X-Signature": sign_request(
            dev_id, b64_key, "POST", "/api/v1/batches", "op-batch-full", payload
        ),
    }
    response = await client.post(
        "/api/v1/batches", content=json.dumps(payload).encode("utf-8"), headers=headers
    ...
    data = response.json()
    assert (
        data["net_credit_t_co2e"] > 0.0
    )  # Means penalty was 0.005 not 30.0 (if yield is 100, 30 penalty would make it negative or 0)


async def test_min_temp_derived_from_array_not_scalar(
    client: AsyncClient, registered_device
):
    from crypto_utils import sign_request
    ...
    await client.post(
        ...
        headers={
            ...
            "X-Signature": sign_request(
                dev_id, b64_key, "POST", "/api/v1/telemetry", "op-tel-deriv", tel
            ),
        },
    )
    yld = {
    ...
    await client.post(
        ...
        headers={
            ...
            "X-Signature": sign_request(
                dev_id, b64_key, "POST", "/api/v1/yield", "op-yld-deriv", yld
            ),
        },
    )
    ...
    headers = {
        ...
        "X-Signature": sign_request(
            dev_id, b64_key, "POST", "/api/v1/batches", "op-batch-deriv", payload
        ),
    }
    response = await client.post(
        "/api/v1/batches", content=json.dumps(payload).encode("utf-8"), headers=headers
...
async def test_under_reported_transport_flagged(
    ...
    await client.post(
        ...
        headers={
            ...
            "X-Signature": sign_request(
                dev_id, b64_key, "POST", "/api/v1/telemetry", "op-tel-transp", tel
            ),
        },
    )
    ...
    headers = {
        ...
        "X-Signature": sign_request(
            dev_id, b64_key, "POST", "/api/v1/batches", "op-batch-transp", payload
        ),
    }
    await client.post(
        "/api/v1/batches", content=json.dumps(payload).encode("utf-8"), headers=headers
    ...
    app_headers = {
        ...
        "X-Signature": sign_request(
            dev_id, b64_key, "POST", "/api/v1/application", "op-app-transp", app_payload
        ),
    }
    resp = await client.post(
        "/api/v1/application",
        content=json.dumps(app_payload).encode("utf-8"),
        headers=app_headers,
    )
